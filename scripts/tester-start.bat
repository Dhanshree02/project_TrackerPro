...
echo ==============================================================================
echo   PMS TrackerPro - Tester Environment (WFH)
echo ==============================================================================
echo.
...
docker compose -f docker-compose.tester.yml ps
...
echo.
echo   To stop testing:        docker compose -f docker-compose.tester.yml down
