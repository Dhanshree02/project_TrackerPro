...
// Types: "active" | "leave" | "weeklyOff" | "holiday"
//   Old wfh / onDuty          → active
//   Old paidLeave / unpaidLeave / noAttendance → leave
//   holiday stays as holiday  (weeklyOff is auto-derived for Sat/Sun)
//
// Member IDs:
...
export const seedScheduleEntries: ScheduleEntry[] = [
  ...
  { memberId: "u1", date: "2026-06-01", type: "active" },
  { memberId: "u1", date: "2026-06-05", type: "active",  sequenceId: "u1-jun-05-07" },
  { memberId: "u1", date: "2026-06-10", type: "active",  sequenceId: "u1-jun-10-11" },
  { memberId: "u1", date: "2026-06-11", type: "active",  sequenceId: "u1-jun-10-11" },
  { memberId: "u1", date: "2026-06-15", type: "holiday", title: "Company Holiday" },
  { memberId: "u1", date: "2026-06-18", type: "active",  sequenceId: "u1-jun-18-22" },
  { memberId: "u1", date: "2026-06-19", type: "active",  sequenceId: "u1-jun-18-22" },
  { memberId: "u1", date: "2026-06-22", type: "active",  sequenceId: "u1-jun-18-22" },
  { memberId: "u1", date: "2026-06-24", type: "active",  sequenceId: "u1-jun-24-28" },
  ...
  { memberId: "u2", date: "2026-06-02", type: "active",  sequenceId: "u2-jun-02-03" },
  { memberId: "u2", date: "2026-06-03", type: "active",  sequenceId: "u2-jun-02-03" },
  ...
  { memberId: "u2", date: "2026-06-12", type: "active" },
  ...
  { memberId: "u2", date: "2026-06-29", type: "active" },
  ...
  { memberId: "u4", date: "2026-06-01", type: "active" },
  { memberId: "u4", date: "2026-06-15", type: "holiday", title: "Company Holiday" },
  { memberId: "u4", date: "2026-06-18", type: "active",  sequenceId: "u4-jun-18-19" },
  { memberId: "u4", date: "2026-06-19", type: "active",  sequenceId: "u4-jun-18-19" },
  { memberId: "u4", date: "2026-06-29", type: "leave",   sequenceId: "u4-jun-27-29" },

  // ── June 2026 — u5 (Nikhil Rao) ──────────────────────────────────────────────
  { memberId: "u5", date: "2026-06-03", type: "active",  sequenceId: "u5-jun-03-04" },
  { memberId: "u5", date: "2026-06-04", type: "active",  sequenceId: "u5-jun-03-04" },
  { memberId: "u5", date: "2026-06-10", type: "active" },
  ...
  // ── July 2026 — u1 ───────────────────────────────────────────────────────────
  { memberId: "u1", date: "2026-07-02", type: "active",  sequenceId: "u1-jul-02-03" },
  { memberId: "u1", date: "2026-07-03", type: "active",  sequenceId: "u1-jul-02-03" },
  { memberId: "u1", date: "2026-07-10", type: "leave",   sequenceId: "u1-jul-10-12" },
  { memberId: "u1", date: "2026-07-20", type: "active" },
  { memberId: "u1", date: "2026-07-28", type: "holiday", title: "Independence Day" },

  // ── July 2026 — u2 ───────────────────────────────────────────────────────────
  { memberId: "u2", date: "2026-07-01", type: "active" },
  { memberId: "u2", date: "2026-07-08", type: "active" },
  ...
  { memberId: "u2", date: "2026-07-28", type: "holiday", title: "Independence Day" },

  // ── July 2026 — u3 ───────────────────────────────────────────────────────────
  { memberId: "u3", date: "2026-07-06", type: "active",  sequenceId: "u3-jul-06-07" },
  { memberId: "u3", date: "2026-07-07", type: "active",  sequenceId: "u3-jul-06-07" },
  { memberId: "u3", date: "2026-07-15", type: "leave" },
  { memberId: "u3", date: "2026-07-24", type: "leave",   sequenceId: "u3-jul-24-26" },
  { memberId: "u3", date: "2026-07-28", type: "holiday", title: "Independence Day" },

  // ── July 2026 — u4 ───────────────────────────────────────────────────────────
  { memberId: "u4", date: "2026-07-03", type: "active" },
  { memberId: "u4", date: "2026-07-13", type: "active",  sequenceId: "u4-jul-13-14" },
  { memberId: "u4", date: "2026-07-14", type: "active",  sequenceId: "u4-jul-13-14" },
  { memberId: "u4", date: "2026-07-28", type: "holiday", title: "Independence Day" },
  ...
  // ── July 2026 — u5 ───────────────────────────────────────────────────────────
  { memberId: "u5", date: "2026-07-02", type: "active" },
  { memberId: "u5", date: "2026-07-09", type: "active" },
  { memberId: "u5", date: "2026-07-17", type: "leave",   sequenceId: "u5-jul-17-19" },
  { memberId: "u5", date: "2026-07-28", type: "holiday", title: "Independence Day" },

  // ── August 2026 — u1 ─────────────────────────────────────────────────────────
  { memberId: "u1", date: "2026-08-03", type: "active" },
  ...
  // ── August 2026 — u2 ─────────────────────────────────────────────────────────
  { memberId: "u2", date: "2026-08-05", type: "active",  sequenceId: "u2-aug-05-06" },
  { memberId: "u2", date: "2026-08-06", type: "active",  sequenceId: "u2-aug-05-06" },
  { memberId: "u2", date: "2026-08-15", type: "holiday", title: "Independence Day" },
  { memberId: "u2", date: "2026-08-20", type: "active" },
  ...
  // ── August 2026 — u4 ─────────────────────────────────────────────────────────
  { memberId: "u4", date: "2026-08-04", type: "active" },
  { memberId: "u4", date: "2026-08-11", type: "active" },
  ...
  // ── August 2026 — u5 ─────────────────────────────────────────────────────────
  { memberId: "u5", date: "2026-08-03", type: "active",  sequenceId: "u5-aug-03-04" },
  { memberId: "u5", date: "2026-08-04", type: "active",  sequenceId: "u5-aug-03-04" },
  { memberId: "u5", date: "2026-08-15", type: "holiday", title: "Independence Day" },
  { memberId: "u5", date: "2026-08-26", type: "active" },

  // ── September 2026 — u1 ──────────────────────────────────────────────────────
  { memberId: "u1", date: "2026-09-01", type: "active",  sequenceId: "u1-sep-01-02" },
  { memberId: "u1", date: "2026-09-02", type: "active",  sequenceId: "u1-sep-01-02" },
  { memberId: "u1", date: "2026-09-11", type: "leave",   sequenceId: "u1-sep-11-13" },

  // ── September 2026 — u2 ──────────────────────────────────────────────────────
  { memberId: "u2", date: "2026-09-07", type: "active" },
  ...
  // ── September 2026 — u3 ──────────────────────────────────────────────────────
  { memberId: "u3", date: "2026-09-03", type: "active" },
  ...
  // ── September 2026 — u4 ──────────────────────────────────────────────────────
  { memberId: "u4", date: "2026-09-04", type: "active" },
  { memberId: "u4", date: "2026-09-09", type: "active",  sequenceId: "u4-sep-09-10" },
  { memberId: "u4", date: "2026-09-10", type: "active",  sequenceId: "u4-sep-09-10" },
  { memberId: "u4", date: "2026-09-25", type: "leave",   sequenceId: "u4-sep-25-27" },

  // ── September 2026 — u5 ──────────────────────────────────────────────────────
  { memberId: "u5", date: "2026-09-02", type: "active" },
  { memberId: "u5", date: "2026-09-14", type: "active" },
