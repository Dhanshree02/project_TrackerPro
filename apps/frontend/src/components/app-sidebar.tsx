...
export function AppSidebar() {
  ...
  return (
    <aside
      className={cn(
        "relative hidden md:flex h-screen sticky top-0 shrink-0 flex-col border-r border-border bg-sidebar text-sidebar-foreground transition-[width] duration-300 z-40",
