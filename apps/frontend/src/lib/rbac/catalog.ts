...
export const ROLE_LABELS: Record<Role, string> = {
  ...
  EngagementManager: "Engagement Manager (EM)",
  Intern: "Intern",
  ...
  "Consulting-HOD": "Consulting Head of Dept",
  ...
  "SOC-Team Leader": "SOC Shift / Team Leader",
...
export const ROLE_PROJECT_SCOPE: Record<Role, ProjectScope> = {
  ...
  HR: "all",
  "Sales Manager": "all",
  "Sales team member": "all",
  PMO: "all",
  EngagementManager: "assigned",
  Intern: "involved",
  "Testing HOD": "department",
  "Testing Senior Manager": "assigned",
  "Testing-Manager": "pm",
  "Testing-Team Leader": "involved",
  "Testing-Team Member": "involved",
  "Consulting-HOD": "department",
  "Consulting-Senior Manager": "assigned",
  "Consulting-Manager": "pm",
  "Consulting-Team Leader": "involved",
  "Consulting-Team member": "involved",
  "SOC-HOD": "department",
  "SOC-Senior Manager": "assigned",
  "SOC-Manager": "pm",
  "SOC-Team Leader": "involved",
  "SOC-Team Member": "involved",
  "R&D - Team member": "involved",
  employee: "involved",
  pm: "pm",
  senior_pm: "assigned",
