            ...
            <div className="w-full max-w-md rounded-2xl border border-border bg-card p-6 shadow-sm text-center my-auto">
              ...
              <div className="flex items-center justify-center gap-3">
                <button
                  type="button"
                  onClick={() => onDownload(document.id, document.fileName)}
                  className="inline-flex items-center gap-2 rounded-lg bg-primary px-5 py-2 text-sm font-medium text-primary-foreground shadow-sm hover:bg-primary/90 transition-all"
                >
