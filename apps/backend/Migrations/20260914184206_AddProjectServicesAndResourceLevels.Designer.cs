...
namespace PMS.API.Migrations
{
    ...
    [Migration("20260914184206_AddProjectServicesAndResourceLevels")]
    partial class AddProjectServicesAndResourceLevels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PMS.API.Modules.Customers.Models.Client", b =>
                {
                    ...
                    b.Property<string>("GroupSpocName")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");
            ...
            modelBuilder.Entity("PMS.API.Modules.Resources.Models.MstBusinessUnit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PMS.API.Modules.Resources.Models.MstEmailDomain", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PMS.API.Modules.Resources.Models.MstOffice", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PMS.API.Modules.Resources.Models.MstReportingManager", b =>
                {
                    ...
                    b.ToTable("mst_reporting_managers", (string)null);
                });
            ...
            modelBuilder.Entity("PMS.API.Modules.Resources.Models.MstWorkLocation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("mst_work_locations", (string)null);
                });
            ...
            modelBuilder.Entity("PMS.API.Modules.Resources.Models.MstOffice", b =>
                {
                    b.HasOne("PMS.API.Modules.Resources.Models.MstWorkLocation", "WorkLocation")
                        .WithMany("Offices")
